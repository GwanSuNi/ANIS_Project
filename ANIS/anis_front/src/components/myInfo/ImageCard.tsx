...
export default function ImageCard({userInfo, handleUploadImageClick}: {
    userInfo: UserInfo,
    handleUploadImageClick?: (studentID: string) => void
}) {
    ...
    return (
        <Card
            ...
            <CardActionArea onClick={() => {
                if (handleUploadImageClick) handleUploadImageClick(userInfo.studentID);
            }}>
