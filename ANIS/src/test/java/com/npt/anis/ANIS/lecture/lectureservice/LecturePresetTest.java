...
public class LecturePresetTest {
    ...
    public void dependencySetting(){
        ...
        lectureDto1 = new LectureDto(1,1,"name",100,2024,1,"서상현",5,1, LocalDateTime.now(),LocalDateTime.now());
        lectureDto2 = new LectureDto(2,1,"name",100,2024,1,"서상현",5, 1,LocalDateTime.now(),LocalDateTime.now());
        lectureDto3 = new LectureDto(3,1,"name",100,2024,1,"서상현",5, 1,LocalDateTime.now(),LocalDateTime.now());
    }
}
