...
export default function DeprecatedSelfLogin() {
    ...
    return (
        <Box sx={{display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center'}}>
            {/*TODO: Autocomplete로 구현, axios로 학생 정보 객체 리스트로 저장해놓기*/}
            <FreeSolo/>
            <Box
                sx={{width: '100%', height: 400, maxWidth: 360, bgcolor: 'background.paper', border: '2px solid grey'}}
            >
                <FixedSizeList
                    height={400}
                    width={360}
    ...
    return (
        <Stack spacing={2} sx={{width: 300}}>
            <Autocomplete
                ...
                renderInput={(params) =>
                    <TextField {...params} label="이름, 생일, 학번, 학과를 검색해보세요"
                               InputProps={{
                                   ...params.InputProps,
                               }}/>}
            />
